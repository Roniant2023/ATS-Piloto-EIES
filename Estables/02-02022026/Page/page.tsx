...
/* =========================
   ✅ NUEVO: Tipos Lección Aprendida
   (salida de /api/lesson-learned-brief)
========================= */
...
export default function Page() {
  ...
  /* =========================
     ✅ NUEVO: LECCIÓN APRENDIDA (UI + state + upload)
  ========================= */
  ...
  const missingReasons = useMemo(() => {
    ...
    // ✅ NUEVO: si incidentes = Sí, exigir lección aprendida procesada
    if (incidentsReference === "Si") {
  ...
  async function handleGenerateATS() {
    ...
    try {
      ...
      // ✅ NUEVO: adjuntar lesson_learned_brief al generar ATS
  ...
  return (
    <div className="max-w-5xl mx-auto p-6 space-y-6">
      ...
      <section className="no-print border rounded p-4 space-y-4">
        ...
        {/* ✅ NUEVO: BLOQUE LECCIÓN APRENDIDA */}
